...
class Blog:
    ...
    def count_published(self):
        ...
        for post in self.get_posts():
            if post.get_is_published() == True:
                result += 1
        return result    



pub_post = Post("Title", "CoolBOD" , True )
unpub_post = Post("Invisible" , "_" , False)
postlist = [pub_post , unpub_post ]
Blog1 = Blog("Richard III" , "Cool Beans", postlist)
assert Blog1.count_published() == 1